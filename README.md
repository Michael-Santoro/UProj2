...
1. The following are a couple of cars adjacent to the lidar sensor.
...
1. Here are a couple more veichles a little further away.
...
1. In this image you can actually see the mirrors of the cars so that direction of travel can be understood.
...
1. In this image we can clearly see a car going the opposite direction.
...
1. By rotating the image in the view we can clearly see a car and a truck in this image.
...
1. Again we can see the back of some cars by rotating the point-cloud image.
...
1. We can clearly see the windsheild and the mirrors and the lights of this car.
...
1. We can see the backs of these cars.
...
1. Another example of the back of some cars.
